  ...
  export default {  
      ...
      methods: {  
          async fetchResources() {  
              try {  
                  const response = await axios.post('http://localhost:8080/qingteng-recruitment/resource?code=0')  
          ...
          async downloadResource(resource) {  
              try {  
                  const response = await axios.post(`http://localhost:8080/qingteng-recruitment/resource_download?id=${resource.id}`, {  
                      name: resource.name  
                  }, {  
